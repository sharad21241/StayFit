...
class PersonalDetailsVC: BaseViewController {
    ...
    func updateUI()
    {
        ...
        //2 - Subtitle Label
        setupUILabel(label: lblSubTitle, lblText: "It will help us to know more about you!", size: fontSizeM, name: fontRegular, color: colorBlack)
        ...
        self.setupButtonWithGradient(firstColor: firstColor, SecondColor: lastColor, btn: btnNext, btnType: .ClearColorWhiteTextWithBorder, fontName: ThemeConstants.shared.Poppins, fontSize: ThemeConstants.shared.FontSizeXXL, title: "Next", isAttributed: true, icon: MBFontello.shared.icon_right)
